...
// Define the props type for UploadButton
interface UploadButtonProps {
    onFilesUploaded: (files: File[]) => void;
}

// UploadButton component with proper typing and comments
const UploadButton: React.FC<UploadButtonProps> = ({ onFilesUploaded }) => {
